...
- **Current Active Task**: `TASK-007` (Integrate Recommendations into `AGENTS.md`)
...
| **[P0]** | `TASK-002` | Document Android Application Update Methods & Dev Workflows | `[done]` | [`PLAN_ANDROID_UPDATES.md`](./PLAN_ANDROID_UPDATES.md) |
...
| **[P1]** | `TASK-003` | Deprecate Legacy `.srt` Format & Enforce JSON3 Sub-Line Segment Highlighting | `[done]` | `json3.md`, `AGENTS.md` (Section 5) |
| **[P1]** | `TASK-004` | Enforce Minimalist Layout, 3-Theme System, & Pure View Component Contracts | `[done]` | `DESIGN_SUBTITLE_VIEWS.md`, `AGENTS.md` (Section 10) |
