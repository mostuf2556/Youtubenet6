...
| **[P0]** | `TASK-008` | Collect and move .md files to docs/ subfolders | `[done]` | `AGENTS.md`, `docs/plans/PLAN_DOCS_ORGANIZATION.md` |
| **[P1]** | `TASK-003` | Deprecate Legacy `.srt` Format & Enforce JSON3 Sub-Line Segment Highlighting | `[done]` | `docs/specifications/json3.md`, `AGENTS.md` (Section 5) |
| **[P1]** | `TASK-004` | Enforce Minimalist Layout, 3-Theme System, & Pure View Component Contracts | `[done]` | `docs/designs/DESIGN_SUBTITLE_VIEWS.md`, `AGENTS.md` (Section 10) |
